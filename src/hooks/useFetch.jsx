...
const useFetch = (url) => {
    ...
    const [ loading, setLoading ] = useState(null); // to keep track of the loading state
    ...
    return { data, loading, error }; // returning an object with the data, loading and error state to be used in the component
}
